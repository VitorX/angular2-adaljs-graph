...
AppModule = __decorate([
    core_1.NgModule({
        ...
        declarations: [app_component_1.AppComponent, graph_component_1.GraphComponent, login_component_1.LoginComponent],
        providers: [graph_service_1.GraphService, secret_service_1.SecretService, core_2.AdalService, RouteGuard_1.RouteGuard, angular2_jwt_1.provideAuth({
